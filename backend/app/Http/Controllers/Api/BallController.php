...
class BallController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'texture_albedo_url' => 'nullable|string|max:255',
            'texture_normal_url' => 'nullable|string|max:255',
            'texture_metallic_url' => 'nullable|string|max:255',
            'texture_roughness_url' => 'nullable|string|max:255',
            'texture_ambient_occlusion_url' => 'nullable|string|max:255',
    ...
    public function update(Request $request, Ball $ball)
    {
        $data = $request->validate([
            ...
            'texture_albedo_url' => 'sometimes|nullable|string|max:255',
            'texture_normal_url' => 'sometimes|nullable|string|max:255',
            'texture_metallic_url' => 'sometimes|nullable|string|max:255',
            'texture_roughness_url' => 'sometimes|nullable|string|max:255',
            'texture_ambient_occlusion_url' => 'sometimes|nullable|string|max:255',
